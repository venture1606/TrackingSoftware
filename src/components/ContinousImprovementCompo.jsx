...
const ContinousImprovementCompo = ({
  ...
  const ImprovementRow = useCallback(({ index, style }) => {
          ...
          <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={10}>
            <Stack spacing={6}>
              ...
              <Box>
                ...
                <Text fontSize="sm" color="gray.600" bg="gray.50" p={3} borderRadius="md" isTruncated noOfLines={2}>{rowData["ROOT CAUSE"] || "-"}</Text>
              </Box>
            </Stack>
            ...
            <Stack spacing={6}>
               <Box>
                ...
                <Text fontSize="sm" color="gray.600" isTruncated noOfLines={2}>{rowData["CORRECTIVE ACTION"] || "-"}</Text>
              </Box>
              <Box>
                <Text fontSize="xs" fontWeight="bold" color="gray.400" textTransform="uppercase" mb={2}>Action Implementation</Text>
                <Text fontSize="sm" color="gray.600" isTruncated noOfLines={2}>{rowData["ACTION IMPLEMENTATION"] || "-"}</Text>
              </Box>
            </Stack>
          </SimpleGrid>
  ...
  }, [rows, getRowData, isView, handleEditClick, handleDeleteRow]);
