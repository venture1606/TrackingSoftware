...
function SideBar() {
  ...
  return (
    ...
    >
      ...
      <Flex justify={sidebarVisible ? "space-between" : "center"} align="center" mb={sidebarVisible ? 2 : 2} px={sidebarVisible ? 2 : 0}>
        <AnimatePresence mode="wait">
            {sidebarVisible && (
                <motion.div
                    ...
                    exit={{ opacity: 0, x: -10 }}
                >
                    <Text fontWeight="800" fontSize="lg" color={textColor} letterSpacing="tight">NAVIGATE</Text>
                </motion.div>
            )}
        </AnimatePresence>
        <IconButton
             ...
             return (
               <Box key={index}>
                 ...
                 <Collapse in={dropdownOpen && sidebarVisible}>
                    <VStack align="stretch" pl={sidebarVisible ? 6 : 0} mt={1} spacing={1}>
                        {DepartmentsListName.map((dept, subIdx) => (
                           <Box
                             key={subIdx}
                             py={2}
                             px={4}
                             ...
                             transition="all 0.2s"
                             color={textColor}
                             _hover={{ bg: hoverBg, color: 'white', transform: 'translateX(4px)' }}
...
const NavItem = ({ icon, label, isActive, onClick, sidebarVisible, isDropdown, isOpen, textColor, activeBg, hoverBg, glassEffect }) => {
                ...
                {sidebarVisible && (
                    ...
                    >
                        <Flex align="center" justify="space-between" w="100%" ml={3}>
                            ...
                            {isDropdown && (
                                <Box transition="transform 0.2s" transform={isOpen ? 'rotate(180deg)' : 'none'}>
