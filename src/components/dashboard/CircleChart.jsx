...
const CircleMetric = ({ value, label, size = "80px", color = "blue.500", suffix = "", maxValue = 100 }) => {
    ...
    <VStack spacing={2}>
      <Box position="relative" display="inline-flex">
        ...
        <Flex position="absolute" top="0" left="0" w="100%" h="100%" align="center" justify="center">
          <Text fontSize="sm" fontWeight="bold" color={color}>{value}{suffix}</Text>
        </Flex>
      </Box>
