...
function Process() {
  ...
  const handleSearchSelectOptions = async () => {
    ...
    const selectOptionsArray = [
      ...
      {
        key: "ORDER STATUS",
        value: ["CLOSED", "PAYMENT PENDING", "SUPPLY PENDING"],
      },
      ...
      { key: "CL STATUS", value: ["Potential Customer", "Active", "Inactive"] },
      {
        key: "FR STATUS",
        value: [
          "General Visit",
      ...
      { key: "DC MODE", value: ["Returnable", "Non-Returnable"] },
      {
        key: "QL STATUS",
      ...
      { key: "CONTROL COPY", value: ["PENDING", "VERIFIED"] },
      { key: "VERIFIED COPY", value: ["PENDING", "VERIFIED"] },
      { key: "PHOTO COPY", value: ["PENDING", "VERIFIED"] },
      { key: "REJECT COPY", value: ["REJECTED"] },
      {
        key: "NPD STATUS",
        value: [
          "Not Feasible",
